...
sealed class Scanner {
    ...
    [Test] public static void Test() => Assert.AreEqual(
        new List<Token>() {
            ...
            new( EQUAL, "=", 1, 6, 1 ),
            new( NUMBER, 5.0, 1, 8, 1 ),
            new( SEMICOLON, ";", 1, 9, 1 ),
            new( IF, "if", 2, 0, 2 ),
            new( LEFT_PAREN, "(", 2, 2, 1 ),
            new( IDENTIFIER, "x", 2, 4, 1 ),
            new( SLASH, "/", 2, 6, 1 ),
            new( NUMBER, 2.0, 2, 8, 1 ),
            new( GREATER_EQUAL, ">=", 2, 10, 2 ),
            new( NUMBER, 0.0, 2, 13, 1 ),
            new( RIGHT_PAREN, ")", 2, 15, 1 ),
            new( STRING, "hello world", 2, 17, 13 ),
            new( SEMICOLON, ";", 2, 30, 1 )},
